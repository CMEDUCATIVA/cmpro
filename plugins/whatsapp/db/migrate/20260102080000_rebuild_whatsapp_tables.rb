class RebuildWhatsappTables < ActiveRecord::Migration[6.1]
  def change
    drop_table :whatsapp_attachments, if_exists: true
    drop_table :whatsapp_messages, if_exists: true
    drop_table :whatsapp_chat_participants, if_exists: true
    drop_table :whatsapp_chats, if_exists: true
    drop_table :whatsapp_contacts, if_exists: true
    drop_table :whatsapp_project_settings, if_exists: true
