(function () {
  ...
  window.WA_COUNTRIES = [
    ...
    { name: "Bermuda", iso2: "BM", dial: "+1-441" },
    ...
    { name: "British Virgin Islands", iso2: "VG", dial: "+1-284" },
    ...
    { name: "Cayman Islands", iso2: "KY", dial: "+1-345" },
    ...
    { name: "East Timor", iso2: "TL", dial: "+670" },
    ...
    { name: "Guam", iso2: "GU", dial: "+1-671" },
    { name: "Guatemala", iso2: "GT", dial: "+502" },
    { name: "Guernsey", iso2: "GG", dial: "+44-1481" },
    ...
    { name: "Montserrat", iso2: "MS", dial: "+1-664" },
    ...
    { name: "Northern Mariana Islands", iso2: "MP", dial: "+1-670" },
    ...
    { name: "Sint Maarten", iso2: "SX", dial: "+1-721" },
    ...
    { name: "Turks and Caicos Islands", iso2: "TC", dial: "+1-649" },
    { name: "Tuvalu", iso2: "TV", dial: "+688" },
    { name: "U.S. Virgin Islands", iso2: "VI", dial: "+1-340" },
