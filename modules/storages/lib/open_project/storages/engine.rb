...
module OpenProject::Storages
  class Engine < ::Rails::Engine
    ...
    config.to_prepare do
      OpenProject::Storages::VersionBadgeHook
    ...
    initializer "openproject_storages.version_badge_assets" do |app|
      app.config.assets.precompile += %w[storages/version_badge_injector.js]
    end
